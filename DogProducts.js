...
let DogsWitems = null;
fetch('http://localhost/webproject/Products/DogsWitems.php', {
    method: "POST"
})
...
function addDataToHTML1() {
    ...
    // add new datas
    if (DogsWitems != null) // if has data
    {
        DogsWitems.forEach(item => {
...
let DogsDitems = null;
fetch('http://localhost/webproject/Products/DogsDitems.php', {
    method: "POST"
})
    .then(response => response.json())
    .then(data => {
...
function addDataToHTML2() {
    ...
    // add new datas
    if (DogsDitems != null) // if has data
    {
        DogsDitems.forEach(item => {
            let newProduct = document.createElement('div');
            newProduct.classList.add('productRow');
            newProduct.classList.add('product-col');
            newProduct.innerHTML =
...
let DogsTitems = null;
fetch('http://localhost/webproject/Products/DogsTitems.php', {
    method: "POST"
})
    .then(response => response.json())
    .then(data => {
...
function addDataToHTML3() {
    // remove datas default from HTML
    let listProductHTML = document.querySelector('.productcontT');

    // add new datas
    if (DogsTitems != null) // if has data
    {
        DogsTitems.forEach(item => {
            let newProduct = document.createElement('div');
            newProduct.classList.add('productRow');
            newProduct.classList.add('product-col');
            newProduct.innerHTML =
...
let DogsAitems = null;
fetch('http://localhost/webproject/Products/DogsAitems.php', {
    method: "POST"
})
    .then(response => response.json())
    .then(data => {
...
function addDataToHTML4() {
    ...
    // add new datas
    if (DogsAitems != null) // if has data
    {
        DogsAitems.forEach(item => {
            let newProduct = document.createElement('div');
            newProduct.classList.add('productRow');
            newProduct.classList.add('product-col');
            newProduct.innerHTML =
