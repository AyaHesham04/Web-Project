...
let CatsWitems = null;
fetch('http://localhost/webproject/Products/CatsWitems.php', {
    method: "POST"
})
...
function addDataToHTML1() {
    ...
    let listProductHTML = document.querySelector('.productcontW');
    listProductHTML.innerHTML = '';

    // add new datas
    if (CatsWitems != null) // if has data
    {
        CatsWitems.forEach(item => {
...
let CatsDitems = null;
fetch('http://localhost/webproject/Products/CatsDitems.php', {
    method: "POST"
})
    .then(response => response.json())
    .then(data => {
...
function addDataToHTML2() {
    // remove datas default from HTML
    let listProductHTML = document.querySelector('.productcontD');
    listProductHTML.innerHTML = '';

    // add new datas
    if (CatsDitems != null) // if has data
    {
        CatsDitems.forEach(item => {
            let newProduct = document.createElement('div');
            newProduct.classList.add('productRow');
            newProduct.classList.add('product-col');
            newProduct.innerHTML =
...
let CatsLitems = null;
fetch('http://localhost/webproject/Products/CatsLitems.php', {
    method: "POST"
})
    .then(response => response.json())
    .then(data => {
...
function addDataToHTML3() {
    // remove datas default from HTML
    let listProductHTML = document.querySelector('.productcontL');
    listProductHTML.innerHTML = '';

    // add new datas
    if (CatsLitems != null) // if has data
    {
        CatsLitems.forEach(item => {
            let newProduct = document.createElement('div');
            newProduct.classList.add('productRow');
            newProduct.classList.add('product-col');
            newProduct.innerHTML =
...
let CatsAitems = null;
fetch('http://localhost/webproject/Products/CatsAitems.php', {
    method: "POST"
})
    .then(response => response.json())
    .then(data => {
...
function addDataToHTML4() {
    // remove datas default from HTML
    let listProductHTML = document.querySelector('.productcontA');
    listProductHTML.innerHTML = '';

    // add new datas
    if (CatsAitems != null) // if has data
    {
        CatsAitems.forEach(item => {
            let newProduct = document.createElement('div');
            newProduct.classList.add('productRow');
            newProduct.classList.add('product-col');
            newProduct.innerHTML =
